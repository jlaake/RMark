...
#' for design} \item{betarand}{dataframe of shrinkage estimates} \item{vcv.beta}{variance-covariance matrix for beta}
...
#' }
var.components=function (theta, design, vcv, alpha, upper=10*max(vcv), LAPACK = TRUE) 
{
...
var.components.old=function(theta,design,vcv,LAPACK=TRUE)
{
#  Arguments:
